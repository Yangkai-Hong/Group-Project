...
namespace VideoStore.Business.Components.TransferService {
    ...
    public interface ITransferService {
        ...
        [System.ServiceModel.OperationContractAttribute(IsOneWay=true, Action="http://tempuri.org/ITransferService/Transfer")]
        System.Threading.Tasks.Task TransferAsync(double pAmount, int pFromAcctNumber, int pToAcctNumber, string BankNotificationAddress);
    }
    ...
    public partial class TransferServiceClient : System.ServiceModel.ClientBase<VideoStore.Business.Components.TransferService.ITransferService>, VideoStore.Business.Components.TransferService.ITransferService {
        ...
        public void Transfer(double pAmount, int pFromAcctNumber, int pToAcctNumber, string BankNotificationAddress) {
            base.Channel.Transfer(pAmount, pFromAcctNumber, pToAcctNumber, BankNotificationAddress);
        }
        
        public System.Threading.Tasks.Task TransferAsync(double pAmount, int pFromAcctNumber, int pToAcctNumber, string BankNotificationAddress) {
            return base.Channel.TransferAsync(pAmount, pFromAcctNumber, pToAcctNumber, BankNotificationAddress);
        }
    }
}
